...
final class ParserTests: XCTestCase, ParserHelpers {
    ...
    func testIntValue() {
        assertParsed(
            GraphQlDocumentParser.intValue,
    ...
    func testFloatValue() {
        assertParsed(
            GraphQlDocumentParser.floatValue,
    ...
    func testStringValue() {
        assertParsed(
            GraphQlDocumentParser.stringValue,
    ...
    func testBooleanValue() {
        assertParsed(
            GraphQlDocumentParser.booleanValue,
    ...
    func testNullValue() {
        assertParsed(
            GraphQlDocumentParser.nullValue,
    ...
    func testEnumValue() {
        assertParsed(
            GraphQlDocumentParser.enumValue,
            input: [.name("test")],
    ...
    func testEmptyList() {
        assertParsed(
            GraphQlDocumentParser.emptyList,
            input: [
    ...
    func testValueListOne() {
        assertParsed(
            GraphQlDocumentParser.valueList(),
            input: [StreamToken.intValue(0)],
            val: [Value.int(0)]
        )
    }
    ...
    func testNonEmptyList() {
        assertParsed(
            GraphQlDocumentParser.nonEmptyList,
            input: [
                StreamToken.leftBracket,
                StreamToken.intValue(0),
                StreamToken.comma,
    ...
    func testListValue() {
        assertParsed(
            GraphQlDocumentParser.listValue,
            input: [
                StreamToken.leftBracket,
                StreamToken.rightBracket,
            ],
    ...
    func testEmptyObject() {
        assertParsed(
            GraphQlDocumentParser.emptyObject,
            input: [
    ...
    func testKeyValueList() {
        assertParsed(
            GraphQlDocumentParser.keyValueList,
            input: [
    ...
    func testObjectValue() {
        assertParsed(
            GraphQlDocumentParser.objectValue,
    ...
    func testDirectiveName() {
        assertParsed(
            GraphQlDocumentParser.directiveName,
    ...
    func testArgument() {
        assertParsed(
            GraphQlDocumentParser.argument,
            input: [
    ...
    func testNamedType() {
        // Test
        assertParsed(
            GraphQlDocumentParser.namedType,
    ...
    func testListType() {
        // [Test]
        assertParsed(
            GraphQlDocumentParser.listType,
            input: [
                StreamToken.leftBracket,
                StreamToken.name("Test"),
                StreamToken.rightBracket,
    ...
    func testNonNullType() {
        // Test!
        assertParsed(
            GraphQlDocumentParser.nonNullType,
            input: [
                StreamToken.name("Test"),
    ...
    func testTypeCondition() {
        // on Test
        assertParsed(
            GraphQlDocumentParser.typeCondition,
            input: [
                StreamToken.on,
                StreamToken.name("Test"),
            ],
    ...
    func testVariable() {
        // $var
        assertParsed(
            GraphQlDocumentParser.variable,
    ...
    func testVariableDefinition() {
        // var: Type
        assertParsed(
            GraphQlDocumentParser.variableDefinition,
            input: [
    ...
    func testVariableDefinitions() {
        assertParsed(
            GraphQlDocumentParser.variableList,
            input: [
    ...
    func testFragmentSpread() {
        assertParsed(
            GraphQlDocumentParser.fragmentSpread,
            input: [
    ...
    func testSimpleOpDefinition() {
        ...
        assertParsed(
            GraphQlDocumentParser.simpleOperationDefinition,
            input: tokens,
    ...
    func testFullOperationDefinition() {
        ...
        assertParsed(
            GraphQlDocumentParser.fullOperationDefinition,
            input: tokens,
            val: OperationDefinition(
    ...
    func testFragmentDefinition() {
        assertParsed(
            GraphQlDocumentParser.fragmentDefinition,
            input: [
    ...
    func testExecutableDefinition() {
        ...
        assertParsed(
            GraphQlDocumentParser.executableDefinition,
            input: expectedTokens,
            val: ExecutableDefinition.opDefinition(OperationDefinition(
                [Selection.field(Field(
                    named: "post",
                    arguments: [
                        Argument(
                ...
                variableDefinitions: [
                    VariableDefinition(
                        name: "postId",
                        type: Type.required(Type.named("ID")),
                        defaultValue: nil,
                        directives: []
                    ),
                ],
